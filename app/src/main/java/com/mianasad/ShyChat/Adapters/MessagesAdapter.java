                ...
                viewHolder.binding.image.setOnLongClickListener(new View.OnLongClickListener() {
                    ...
                    public boolean onLongClick(View view) {
                        LayoutInflater inflater = (LayoutInflater)
                                viewHolder.binding.image.getContext().getSystemService(Context.LAYOUT_INFLATER_SERVICE);
                        PopupWindow popupWindow = new PopupWindow(inflater.inflate(R.layout.popup_image_chat,null,false), ViewGroup.LayoutParams.MATCH_PARENT, ViewGroup.LayoutParams.WRAP_CONTENT,true);
                        ImageView im = (ImageView) popupWindow.getContentView().findViewById(R.id.full_image);
                        Glide.with(context)
                                .load(message.getImageUrl())
                                .placeholder(R.drawable.placeholder)
                                .into(im);
                        popupWindow.showAtLocation(viewHolder.binding.image, Gravity.CENTER,0,0);
                        Button btn = (Button) popupWindow.getContentView().findViewById(R.id.back);
...
//                    else
//                        Toast.makeText(context, "You Don't React at this time", Toast.LENGTH_SHORT).show();
//                    return false;
//                }
//            });
